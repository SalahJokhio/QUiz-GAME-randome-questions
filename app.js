var questions = ["1. Declare a variable named 'age' and assign it the value 25.",
...
for (var i = 0; i < boxes.length; i++) {
    boxes[i].addEventListener("click", function() {
        ...
        this.style.fontSize = "22px"; // Corrected style property name
...
function clearAll() {
    for (var i = 0; i < boxes.length; i++) {
        ...
        boxes[i].style.fontSize = "25px"; // Corrected style property name
